...
// Target: Minecraft 1.21.1 / NeoForge / KubeJS 2101.7.x
//
...
;(function () {
  ...
  function getTPS(server) {
    try {
      // 1.20.5+ removed getAverageTickTime(); only the nanos variant remains.
      let avgTickMs = server.getAverageTickTimeNanos() / 1000000.0
